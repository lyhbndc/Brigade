...
<html lang="en">
<head>
<title>Brigade Clothing - Daily</title>
<meta charset="utf-8">
			...
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Daily (Longsleeve)</a></li>
					</ul>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					<div class="product_details_title">
						<h2>BRIGADE CLOTHING - Daily (Longsleeve)</h2>
					...
					<div class="original_price">₱900.00</div>
