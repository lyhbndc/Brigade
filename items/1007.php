...
<html lang="en">
<head>
<title>Brigade Clothing - Sting</title>
<meta charset="utf-8">
			...
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Sting</a></li>
					</ul>
				</div>
					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li class="active"><img src="images\1007\t1.png" alt="" data-image="images/1007/1.png"></li>
									<li ><img src="images\1007\t2.png" alt="" data-image="images/1007/2.png"></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(images/1007/1.png)"></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div id="tab_1" class="tab_container active">
						<div class="row">
							...
							<div class="col-lg-5 offset-lg-2 desc_col">
								<div class="tab_image">
									<img src="images\1007\i1.png" alt="">
								</div>
