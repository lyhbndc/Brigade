...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    foreach ($cartData as $item) {
        ...
        $query = "INSERT INTO `order` (OrderID, Customer, Product, Quantity, Size, Status, Total, Date, Address, Email)
                  VALUES ('$orderID', '$fullname', '$product', '$quantity', '$size', '$status', '$total', NOW(), '$address', '$email')";
        $result = mysqli_query($conn, $query);
